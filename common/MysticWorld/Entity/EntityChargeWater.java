...
public class EntityChargeWater extends Entity {
	...
	public EntityChargeWater(World par1World) 
	{
		super(par1World);
	}
	
    public EntityChargeWater(World par1World, EntityLiving par2EntityLiving)
    {
        super(par1World);
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            MysticWorld.proxy.waterFX(this.worldObj, this.posX + (rand.nextDouble()/2), this.posY + 0.5D, this.posZ + (rand.nextDouble()/2), 1.0F);
            this.setPosition(this.posX, this.posY, this.posZ);
        }
    }
