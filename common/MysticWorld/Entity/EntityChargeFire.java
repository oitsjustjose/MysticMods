...
public class EntityChargeFire extends Entity {
    ...
    public EntityChargeFire(World par1World, EntityLiving par2EntityLiving)
    {
        super(par1World);
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            MysticWorld.proxy.fireFX(this.worldObj, this.posX, this.posY + 0.5D, this.posZ, 1.0F);
            this.setPosition(this.posX, this.posY, this.posZ);
        }
    }
