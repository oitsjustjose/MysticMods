...
public class ItemStaffWaterRenderer implements IItemRenderer {
	
	private final ModelStaff model;
	
	public ItemStaffWaterRenderer()
	{
	...
	private void renderModel(float x, float y, float z, float scale)
	{
        ...
        FMLClientHandler.instance().getClient().renderEngine.func_110577_a(new ResourceLocation("mystictextures:textures" + "/models/StaffWater.png"));
