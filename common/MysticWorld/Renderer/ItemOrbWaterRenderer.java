...
public class ItemOrbWaterRenderer implements IItemRenderer {

	 private ModelOrb modelOrb;
     
	 public ItemOrbWaterRenderer()
	 {
	...
	public void renderOrb(float x, float y, float z, float scale)
	{
	    ...
	    FMLClientHandler.instance().getClient().renderEngine.func_110577_a(new ResourceLocation("mystictextures:textures" + "/models/OrbWater.png"));
