...
public class ItemStaffEnergyRenderer implements IItemRenderer {
	private final ModelStaff model;

	public ItemStaffEnergyRenderer() {
	...
	private void renderModel(float x, float y, float z, float scale) {
		...
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(new ResourceLocation("mysticmods:textures" + "/models/StaffEnergy.png"));
