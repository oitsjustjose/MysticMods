...
public class EnergyFX extends EntityFX
{
  public EnergyFX(World world, double x, double y, double z)
  {
    super(world, x, y, z);
  }

  public EnergyFX(World world, double x, double y, double z, float scale){
	  super(world, x, y, z);
