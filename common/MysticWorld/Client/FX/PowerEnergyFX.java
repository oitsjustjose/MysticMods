...
public class PowerEnergyFX extends EntityFX
{
  public PowerEnergyFX(World world, double x, double y, double z)
  {
    super(world, x, y, z);
  }

  public PowerEnergyFX(World world, double x, double y, double z, float scale){
	  super(world, x, y, z);
  ...
  public void renderParticle(Tessellator tessellator, float par2, float par3, float par4, float par5, float par6, float par7)
  {
	  ...
	  FMLClientHandler.instance().getClient().renderEngine.func_110577_a(new ResourceLocation("/assets/MysticTextures/textures/misc/energyFX.png"));
