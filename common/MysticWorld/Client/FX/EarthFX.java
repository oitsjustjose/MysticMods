...
public class EarthFX extends EntityFX
{
  public EarthFX(World world, double x, double y, double z)
  {
    super(world, x, y, z);
  }

  public EarthFX(World world, double x, double y, double z, float scale){
	  super(world, x, y, z);
