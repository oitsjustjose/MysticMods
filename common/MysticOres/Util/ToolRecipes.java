...
public class ToolRecipes {
	public static void AdvancedAxeRecipe(Item output, ItemStack input) {
		GameRegistry.addRecipe(new ItemStack(output, 1), new Object[] { "## ", "#S ", " S ", 'S', new ItemStack(Items.Resource, 1, 13), '#', input });
		GameRegistry.addRecipe(new ItemStack(output, 1), new Object[] { "## ", "S# ", "S  ", 'S', new ItemStack(Items.Resource, 1, 13), '#', input });
	}
	...
	public static void AdvancedSwordRecipe(Item output, ItemStack input) {
		GameRegistry.addRecipe(new ItemStack(output, 1), new Object[] { "#", "#", "S", 'S', new ItemStack(Items.Resource, 1, 13), '#', input });
	}

	public static void AxeRecipe(Item output, ItemStack input) {
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(output, 1), "## ", "#S ", " S ", 'S', "stickWood", '#', input));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(output, 1), "## ", "S# ", "S  ", 'S', "stickWood", '#', input));
	}
	...
	public static void SwordRecipe(Item output, ItemStack input) {
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(output, 1), "#", "#", "S", 'S', "stickWood", '#', input));
	}
}
